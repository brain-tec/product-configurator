...
--- | --- | --- | ---
[product_configurator](product_configurator/) | 17.0.1.0.2 | [![PCatinean](https://github.com/PCatinean.png?size=30px)](https://github.com/PCatinean) | Base for product configuration interface modules
